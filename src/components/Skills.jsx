            ...
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 relative">
              <div className="max-w-xl mx-auto text-center">
                ...
                <p className="mt-4 text-base leading-relaxed text-gray-600 group-hover:text-white">
                  I&apos;m a graduate with a Master of Science in Management of
                  Information Systems, Master of computer Apllications and a
                  Bachelor of Science in Mathematics. With a keen interest in
                  problem-solving and innovation, I&apos;ve honed my skills in
              ...
              <div className="grid grid-cols-1 gap-2 mt-12 sm:grid-cols-3 lg:mt-20   ">
                ...
                >
                  ...
                  <div className="py-2 px-9 relative  ">
                    <MdBrowserUpdated className="w-16 h-16 fill-gray-400 group-hover:fill-white" />
                    ...
                    <p className="mt-4 text-base text-gray-600 group-hover:text-white  ">
                      As a frontend developer, I have the expertise to create
                      visually appealing and user-friendly interfaces for web
                      applications.
                    </p>
                    <p className="mt-4 text-base text-gray-600 group-hover:text-white  ">
                      I can develop responsive and interactive web pages using
                      HTML, CSS, and JavaScript, frameworks such as React.js,
                      Boostrap, Tailwind. I can use tools like Figma and Canva.
                    </p>
                  </div>
                </a>
                <a
                ...
                >
                  <div className=" absolute  bg-blue-500/50 top-0 left-0 w-24 h-1 z-30  transition-all duration-200   group-hover:bg-white group-hover:w-1/2  "></div>
                  <div className="py-2 px-9 relative  ">
                    <RiDatabaseLine className="w-16 h-16 fill-gray-400 group-hover:fill-white" />
                    <h3 className="mt-8 text-lg font-semibold text-black group-hover:text-white ">
                      Backend Developer
                    </h3>
                    <p className="mt-4 text-base text-gray-600 group-hover:text-white">
                      As a backend developer, I have the skills to develop the
                      server-side logic and database management for web
                      applications.
                    </p>
                    <p className="mt-4 text-base text-gray-600 group-hover:text-white">
                      I can develop robust server-side applications using Java
                      and Spring Boot, implementing RESTful APIs for
                      communication with frontend interfaces as well as Design
                      and manage relational databases using SQL and MongoDB,
                ...
                >
                  <div className=" absolute  bg-blue-500/50 top-0 left-0 w-24 h-1 z-30  transition-all duration-200   group-hover:bg-white group-hover:w-1/2  "></div>
                  <div className="py-2 px-9 relative  ">
                    <BsTools className="w-16 h-16 fill-gray-400 group-hover:fill-white" />
                    <h3 className="mt-8 text-lg font-semibold text-black group-hover:text-white ">
                      Tools and Technologies
                    </h3>
                    <p className="mt-4 text-base text-gray-600 group-hover:text-white">
                      I can use Git/GitHub for version control, Postman for API
                      development and testing, and npm for managing JavaScript
                      packages.
                    </p>
                    <p className="mt-4 text-base text-gray-600 group-hover:text-white">
                      Moreover, Docker facilitates application containerization
                      and Jenkins automates CI/CD pipelines. Finally, I can
                      deploy applications on AWS for scalable and reliable
